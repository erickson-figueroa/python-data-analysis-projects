...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="./COVID19_Impact_Analysis"><strong>COVID-19 Impact on World Economies</strong></a></td>
      <td>Analyze the economic impact of the COVID-19 pandemic on various countries and industries.</td>
    </tr>
    <tr>
...
<ul>
    ...
    <br>
    <li>
        <strong>Explore Plotly for Interactive Visualizations:</strong><br>
        <a href="https://plotly.com/" target="_blank">Learn Plotly</a> to create interactive data visualizations for deeper analysis.
    </li>
</ul>
